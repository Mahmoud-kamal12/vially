...
SELECT item,Price,Quantity,Discount,Total,SupplierID,BuyPrice,date,type,sales_type,subqty from ".$prefix."_sales_temporary")){
        ...
        if($_GET['print_inv']!==null){
            ...
            ##############
            ?>
            <a href="#" onclick="javascript:void window.open('invoice.php?id=<?php echo"".$_GET['print_inv'].""; ?>&type=sale','13909375026416','width=700,height=600,toolbar=0,menubar=0,location=0,status=0,scrollbars=1,resizable=0,left=0,top=0,menubar=0');return false;"><img src="images/print_icon.gif" style="width:30px; height:30px; float:left; border:0px;" title="<?php echo"$Print_previous_bill_lang"; ?>" /></a>
...
VALUES ('8','".($paid*-1)."','".$DueDate."','.$Bill_No_lang.".$get_LastInvoiceNo."')";
