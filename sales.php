        ...
        <?php } ?>
							...
							'.$suspended_bill_lang.'
                                    ...
                                    if (is_numeric($_POST['submit']) == 1 and $_POST['submit'] != null) {
                                        ...
                                        if ($_POST['seller'] == "" or $_POST['seller'] == null) {
                                            echo'<div style="text-align:center; background-color:#E18C80; border-radius:5px;">
...
VALUES ('" . $get_LastInvoiceNo . "','" . $DueDate . "','" . $inv_Total . "','" . $_POST['SupplierID'] . "','" . $pay . "','','" . $CheckNumber . "','" . $notes . "','1','" . $paid . "','" . $alldiscount . "','". $customer_cach_name . "','" .  $customer_cach_phone . "','" . $saller  . "')")) {
...
SELECT (CASE when sales_type=2 then  Quantity/subqty else Quantity END) ,Discount,Total,SupplierID,BuyPrice,date,type,sales_type,subqty,inv_id,item,Price,size,color,user_id from " . $prefix . "_sales_temporary where user_id='$user_id'")) {
