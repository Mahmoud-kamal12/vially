                    ...
                    <form id="myForm" method="post" name="myForm">
                        ...
                        <table border="0" dir="rtl" cellpadding="0" style="padding-top:0px; text-align:right; color:#009; width:100%;">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div><select class="form-control" id="TimeZone" name="TimeZone" dir="ltr">
                                ...
                                <td class="text-right">
                                    <div><input type="text" name="Phone" value="<?php echo "" . $get_db_Phone . ""; ?>" id="Phone" class="form-control" /></div>
                                </td>
                            </tr>
                            <tr>
                                <td class="text-right"><label><?php echo "$Currency_lang"; ?></label></td>
                                <td class="text-right">
                                    <div><select name="Currency" class="form-control">
                                ...
                                <td class="text-right">
                                    <div><input type="text" name="E_mail" value="<?php echo "" . $get_db_E_mail . ""; ?>" class="form-control" />
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div><input type="text" name="Address" id="Address" value="<?php echo "" . $get_db_Address . ""; ?>" class="form-control" /></div>
                                </td>
                                <td class="text-right"><label><?php echo "$Return_Policy_lang"; ?></label></td>
                                <td class="text-right">
                                    <div><input type="text" name="ReturnPolicy" id="ReturnPolicy" value="<?php echo "" . $get_db_ReturnPolicy . ""; ?>" class="form-control" /></div>
                                </td>
                                <td class="text-right"><label><?php echo "$Printing_after_sales_lang"; ?></label></td>
                                <td class="text-right">
                                    <div><input type="checkbox" name="PrintingAftermarket" value="1" <?php if ($get_db_PrintingAftermarket == 1) {
                                                                                                            echo 'checked="checked"';
                                                                                                        } ?> style="width:20px; height:10px;" /></div>
                                </td>
                            </tr>
                            <tr>
                                <td class="text-right"><label><?php echo "$language_lang"; ?></label></td>
                                <td class="text-right">
                                    <div><select name="Language" class="form-control">
