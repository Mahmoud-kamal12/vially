...
<body class="cmenu1 example-target">
   ...
   ' . $expense_amount_lang . '
                                ...
                                if (isset($_POST['modification'])) {
                                    ...
                                    $sql = "UPDATE " . $prefix . "_expenses SET type='" . $type . "',Amount='" . $Amount . "',date='" . $date . "',Employee='" . $Employee . "',details='" . $details . "' where id=" . $_POST['id'] . "";
                                } else {
                                    $sql = "INSERT INTO " . $prefix . "_expenses (type, Amount, date, Employee, details)
...
VALUES ('5','" . ($Amount * -1) . "','" . $date . "',' " . $ex_typex . "')";
