                        ...
                        <table border="0" dir="rtl" cellpadding="0" style="padding-top:30px; text-align:right; color:#009; width:100%;">
                            <tr>
                                ...
                                <td style="text-align:right; direction:rtl;">
                                    <div class="row"><input type="text" name="Amount" value="<?php echo "" . $row_expenses_Amount . ""; ?>" class="form-control" /></div>
                                </td>
                                <td style="text-align:right; direction:rtl;">
                                    <h2><?php echo "$the_date_lang"; ?></h2>
                                </td>
                                <td class="text-right">
                                    <div class="row"><input type="text" name="date" value="<?php if ($row_expenses_date == "") {
                                                                                                echo date("d/m/Y");
                                                                                            } else {
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row"><input type="text" name="Employee" value="<?php echo "" . $row_expenses_Employee . ""; ?>" class="form-control" /></div>
                                </td>
                                <td>
                                    <h2><?php echo "$Details_lang"; ?></h2>
                                </td>
                                <td colspan="3">
                                    <div class="row"><textarea name="details" class="form-control"><?php echo "" . $row_expenses_details . ""; ?></textarea></div>
                                </td>
                            </tr>
