...
if(isset($_POST['modification'])){
			...
			$sql="UPDATE ".$prefix."_staff SET name='".$name."',phone='".$phone."',address1='".$address1."',address2='".$address2."',email='".$email."',notes='".$notes."' where id=".$_POST['id']."";
	}else{
			$sql="INSERT INTO ".$prefix."_staff (name, phone, date, address1, address2, email, notes, balance, state)
...
<br />
 ...
 <table  border="0" dir="rtl" cellpadding="0" style="padding-top:30px; text-align:right; color:#009; width:100%;">
  <tr>
        <td class="text-right"><lable><?php echo"$Employee_name"; ?></lable></td>
        <td class="text-right">
 ...
 <input type="text" name="name" value="<?php echo"".$row_staff_name.""; ?>"  class="form-control"/>
      ...
      <tr>
        ...
        <td  class="text-right"><div><input type="text" name="address2" value="<?php echo"".$row_staff_address2.""; ?>"  class="form-control" />
          </div>
</td>
