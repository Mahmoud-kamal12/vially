...
$to=stripslashes(date('Y-m-d',strtotime($to)));
	...
	*/
	$query = "SELECT COUNT(*) as num  FROM  ".$prefix."_sales_inv where  ".$seller." type='2' and  left(date, 10) BETWEEN '".$from."' AND '".$to."'";
...
?>
 ...
 <a href="#" onclick="javascript:void window.open('edit_invoice.php?id=<?php echo"".$row['inv_id'].""; ?>&type=sales_returns','1390937502641','width=700,height=600,toolbar=0,menubar=0,location=0,status=0,scrollbars=1,resizable=0,left=0,top=0,menubar=0');return false;"><img src="images/edit.png"/></a>
