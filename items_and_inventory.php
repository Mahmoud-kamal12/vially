            ...
            if ($_GET['del'] !== null) {
                if($demo==1){
                  ...
                  '.$demo_alert.'
                            ...
                            if(mysqli_query($con, "DELETE FROM items WHERE id='" . $_GET['del'] . "'")){
            ...
            if (isset($_POST['add']) or isset($_POST['modification'])) {
                if($demo==1){
                  ...
                  '.$demo_alert.'
                    ...
                    if($OrderNo==""){$OrderNo=last_group_rank();}
                    ...
                    if ($groups == null or $groups == "" or $items == null or $items == "" or $date == null or $date == "" or $price == null or $price == "" or $Sale_price == null or $Sale_price == "") {
                        ...
                        if ($companies == null or $companies == "") {
                            $error_companies = 'background-color:#FC9698';
                        }
                    ...
                    <table  border="0" dir="rtl" cellpadding="0" style="padding-top:30px; text-align:right; color:#009; width:100%;">
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <select name="companies" class="form-control"  style="width:80%; float: right; <?php echo"$error_companies"; ?>">
                                    <option value=""></option>
                                    <?php
...
####################
        ...
        <div>
            <form method="get">
                <select name="companies" size="1" class="w25" class="text-center">
                    <option value=""><?php echo"$Manufacturer_company_lang"; ?></option>
                    <?php
        ...
        <form id="mainform" action="" method="post">
            <table border="1" style="font-size: 16px; width: 100%; direction: rtl; border: 1px; border-collapse: collapse; margin-top: 10px;text-align:center; table-layout: fixed;"    class="container" id="container">
                ...
                <?php if($user_Cost_price =="1" or $user_IsAdmin ==1){?>
                    <th  class="text-center  <?php if ($_GET['type'] == "ASC" and $_GET['orderby'] == "price") {
                        ...
                        echo"sort0";
                            ...
                            echo"DESC";
                        } ?>&page=<?php echo"" . $_GET['page'] . ""; ?>" class="a_remove_underlines"><?php echo"$Purchasing_price_lang"; ?></a>
                    </th>
                <?php } ?>
                ...
                if ($_GET['search'] == "" or $_GET['search'] == null) {
                    ...
                    $query = "SELECT COUNT(*) as num  FROM  items where id NOT IN(".get_hide_items().") and  id='$search' or item like '%$search%' and groupid='" . $_GET['groups'] . "'  order by $orderby $type";
                }
                ...
                if ($orderby == "item") {
                    ...
                    if ($_GET['search'] == "" or $_GET['search'] == null) {
                        ...
                        if ($_GET['groups'] == null) {
                            if ($_GET['companies'] == "" or $_GET['companies'] == null) {
                                $sql = "SELECT * FROM items where id NOT IN(".get_hide_items().") and id='$search' or item like '%$search%' order by $orderby $type LIMIT $start, $limit";
                            } else {
                                $sql = "SELECT * FROM items where id NOT IN(".get_hide_items().") and companies='" . $_GET['companies'] . "' and id='$search' or item like '%$search%' order by $orderby $type LIMIT $start, $limit";
                            }
                        } else {
                            if ($_GET['companies'] == "" or $_GET['companies'] == null) {
                                $sql = "SELECT * FROM items where id NOT IN(".get_hide_items().") and id='$search' or item like '%$search%'  and groupid='" . $_GET['groups'] . "' order by $orderby $type LIMIT $start, $limit";
                            } else {
                                $sql = "SELECT * FROM items where id NOT IN(".get_hide_items().") and companies='" . $_GET['companies'] . "' and id='$search' or item like '%$search%'  and groupid='" . $_GET['groups'] . "' order by $orderby $type LIMIT $start, $limit";
                            }
                        }
                    }
                    ...
                    if ($_GET['search'] == "" or $_GET['search'] == null) {
                        ...
                        if ($_GET['groups'] == null) {
                            if ($_GET['companies'] == "" or $_GET['companies'] == null) {
                                $sql = "SELECT * FROM items where id NOT IN(".get_hide_items().") and id='$search' or item like '%$search%' order by $orderby+0 $type LIMIT $start, $limit";
                            } else {
                                $sql = "SELECT * FROM items where id NOT IN(".get_hide_items().") and companies='" . $_GET['companies'] . "' and id='$search' or item like '%$search%' order by $orderby+0 $type LIMIT $start, $limit";
                            }
                        } else {
                            if ($_GET['companies'] == "" or $_GET['companies'] == null) {
                                $sql = "SELECT * FROM items where id NOT IN(".get_hide_items().") and id='$search' or item like '%$search%' and groupid='" . $_GET['groups'] . "' order by $orderby+0 $type LIMIT $start, $limit";
                            } else {
                                $sql = "SELECT * FROM items where id NOT IN(".get_hide_items().") and companies='" . $_GET['companies'] . "' and  id='$search' or item like '%$search%' and groupid='" . $_GET['groups'] . "' order by $orderby+0 $type LIMIT $start, $limit";
                            }
                        }
                    }
                }
...
<td class="text-center ">
    ...
    <?php if($user_Item_movement_detection =="1" or $user_IsAdmin == 1){ ?>
