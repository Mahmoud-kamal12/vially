									  ...
									  <tr>
										...
										if ($num_sizes > 0) {
											...
											echo "<tr> 
												...
												<a href='?unpurshes_order&order_id={$row_sizes['id']}' style='width:120px; height:40px;'>تحويل</a>

												<a href='inv_barcode.php?order_id={$row_sizes['id']}' style='width:120px; height:40px;margin:0 10px 0 10px'> بار كود</a>

												<a href='?delete_order&order_id={$row_sizes['id']}' style='width:120px; height:40px;'>حذف</a>
