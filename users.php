...
<hr style="color:#E8E8E8;" />
  ...
  <tr>
    ...
    <th class="text-right"><label for="ModifyBillsBuy"><!--تعديل فواتير شراء--><?php echo"$Inventory_reports_lang"; ?></label></th>
  ...
  <tr>
      ...
      <th class="text-right"><label for="colors">الالوان</label></th>
      ...
      <th class="text-right"><label for="sizes">المقاسات</label></th>
