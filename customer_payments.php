...
' . $enter_data_correctly_lang . '
                            ...
                            if (isset($_POST['modification'])) {
                                ...
                                $sql = "UPDATE " . $prefix . "_sales_inv SET supplier='" . $SupplierID . "',Total='" . $Amount . "',date='" . $Date . "',PaymentMethod='" . $PaymentMethod . "',DueDate='" . $Due_Date . "',notes='" . $notes . "',type='3' where id=" . $_POST['id'] . "";
                            } else {
                                $sql = "INSERT INTO " . $prefix . "_sales_inv (supplier, Total, date, PaymentMethod, DueDate, notes, type)
...
VALUES ('7','" . ($Amount) . "','" . date("Y-m-d G:i:s") . "','.$Collection_customer" . $SupplierID . "')";
                ...
                <form id="myForm" method="post" name="myForm" enctype="multipart/form-data">
                    <table border="0" dir="rtl" cellpadding="0" style="padding-top:30px; text-align:right; color:#009; width:100%;">
                        <tr>
                            <td class="text-right">
                                <lable><?php echo "$The_client_lang"; ?></lable>
                            </td>
                            <td>
                                <?php
                            ...
                            <td class="text-right">
                                <lable><?php echo "$the_amount_lang"; ?></lable>
                            </td>
    ...
    <tr>
        <td class="text-right">
            <lable> <?php echo "$payment_method_lang"; ?></lable>
        </td>
        <td class="text-right">
        ...
        <td>
            <lable><?php echo "$due_date_lang"; ?></lable>
        </td>
        <td class="text-right">
    ...
    <tr>
        <td class="text-right">
            <lable><?php echo "$Details_lang"; ?></lable>
        </td>
        <td class="text-right">
            <lable>
    ...
    <form id="mainform" action="" method="post">
        <table border="1" style="font-size:16px; width:100%; direction:rtl; border:1px; border-collapse:collapse; margin-top:10px; text-align:center;" class="container" id="container">
            <thead style="background-color:#CCC;">
                ...
                <th class="text-center <?php if ($_GET['type'] == "ASC" and $_GET['orderby'] == "Due_Date") {
                                            echo "sort_t";
                                        } else if ($_GET['type'] == "DESC" and $_GET['orderby'] == "Due_Date") {
                                            echo "sort_d";
                                        } else {
                                            echo "sort0";
                                        } ?>"><a href="?id=<?php echo "" . $_GET['id'] . ""; ?>&orderby=Due_Date&type=<?php if ($_GET['type'] == "ASC") {
                                                                                                            echo "DESC";
                                                                                                        } else if ($_GET['type'] == "DESC") {
                                                                                                            echo "ASC";
                                                                                                        } else {
                                                                                                            echo "DESC";
                                                                                                        } ?>&page=<?php echo "" . $_GET['page'] . ""; ?>" class="a_remove_underlines"><?php echo "$due_date_lang"; ?></a></th>
            ...
            ?>
                ...
                <tr class="<?php echo "" . $class . ""; ?>">
                    ...
                    <td class="text-center">
                        ...
                        <a href="?id=<?php echo "" . $row['supplier'] . ""; ?>&SupplierID=<?php echo "" . $row['supplier'] . ""; ?>&limit=<?php echo "" . $_GET['limit'] . ""; ?>&orderby=<?php echo "" . $_GET['orderby'] . ""; ?>&type=<?php echo "" . $_GET['type'] . ""; ?>&page=<?php echo "" . $_GET['page'] . ""; ?>&Edit=<?php echo "" . $row['id'] . ""; ?>"><img src="images/edit.png" /></a>
                    </td>
                </tr>
