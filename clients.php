      ...
      ' . $Data_is_saved_lang . '
                ...
                <form id="myForm" method="post" name="myForm" enctype="multipart/form-data">
                    <table border="0" dir="rtl" cellpadding="0"
                        ...
                        <tr>
                            <td class="text-right">
                                <lable><?php echo "$customer_name_lang"; ?></lable>
                            </td>
                            <td class="text-right">


                                <input type="text" name="name" value="<?php echo "" . $row_clients_name . ""; ?>"
                                    class="form-control" />


                            </td>
                            <td class="text-right">
                                <lable><?php echo "$Phone_number_lang"; ?></lable>
                            </td>
                            <td class="text-right"><input type="text" name="phone"
                                    value="<?php echo "" . $row_clients_phone . ""; ?>" class="form-control" /></td>
                            <td class="text-right">
                        ...
                        <tr>
                            <td class="text-right">
                                <lable><?php echo "$Address1_lang"; ?></lable>
                            </td>
                            <td class="text-right"><input type="text" name="address1"
                                    value="<?php echo "" . $row_clients_address1 . ""; ?>" class="form-control" />
                            </td>
                            <td class="text-right">
                                <lable><?php echo "$Address2_lang"; ?></lable>
                            </td>
                            <td class="text-right"><input type="text" name="address2"
                                    value="<?php echo "" . $row_clients_address2 . ""; ?>" class="form-control" />

                            </td>
                            <td class="text-right">
                                <lable><?php echo "$Email_lang"; ?></lable>
                            </td>
                            <td class="text-right"><input type="text" name="email"
                                    value="<?php echo "" . $row_clients_email . ""; ?>" class="form-control" />
                        ...
                        <tr>
                            ...
                            <td class="text-right"><span>
                                    <textarea name="notes"
                                        class="form-control"><?php echo "" . $row_clients_notes . ""; ?></textarea>
                                </span></td>
                            <td class="text-right">
                                <lable><?php echo "$opening_balance_lang"; ?></lable>
                            </td>
                            <td class="text-right"><input type="text" name="balance"
                                    value="<?php echo "" . $row_clients_balance . ""; ?>" class="form-control" /></td>
                        </tr>
                            ...
                            <td>
                                <div>
                                    ...
                                    <input type="button" class="button" value="<?php echo "$Cancel_lang"; ?>"
                                        onclick="javascript:location.href = 'clients.php'" />
                                </div>
                            </td>
                        </tr>
                        <tr>
            ...
            <form id="mainform" action="" method="post">
                <table border="1"
                    style="font-size:16px; width:100%; direction:rtl; margin-bottom:40px; border:1px; border-collapse:collapse; margin-top:10px; text-align:center;"
                    ...
                    <thead style="background-color:#CCC;">
                        ...
                        <th class="text-center <?php if ($_GET['type'] == "ASC" and $_GET['orderby'] == "id") {
                                ...
                                href="?orderby=id&type=<?php if ($_GET['type'] == "ASC") {
                                                                            echo "DESC";
                        ...
                        <th class="text-center <?php if ($_GET['type'] == "ASC" and $_GET['orderby'] == "name") {
                                ...
                                href="?orderby=name&type=<?php if ($_GET['type'] == "ASC") {
                                                                                echo "DESC";
                                                                            } else if ($_GET['type'] == "DESC") {
                                                                                echo "ASC";
                                                                            } else {
                        ...
                        <th class="text-center <?php if ($_GET['type'] == "ASC" and $_GET['orderby'] == "phone") {
                                ...
                                class="a_remove_underlines"><?php echo "$Phone_number_lang"; ?></a></th>
                        ...
                        <th class="text-center <?php if ($_GET['type'] == "ASC" and $_GET['orderby'] == "address2") {
                                ...
                                class="a_remove_underlines"><?php echo "$Address2_lang"; ?></a></th>
              ...
              return false;"><img width="25" height="25" src="images/print_icon.gif" style="border:0px;"></a></th>
                    ...
                    <tr class="<?php echo "" . $class . ""; ?>">
                        ...
                        <td class="text-center"><a
                                href="customer_payments.php?id=<?php echo "" . $row['id'] . ""; ?>"><?php echo "" . $row['id'] . ""; ?></a>
                        </td>
                        ...
                        <td class="text-center"><?php
                                 ...
                                 */
                                                        print round(($totalreceivings + $row['balance']), 2);
                                                        ?></td>
                        ...
                        <td class="text-center">
                            ...
                            <a
                                href="?limit=<?php echo "" . $_GET['limit'] . ""; ?>&orderby=<?php echo "" . $_GET['orderby'] . ""; ?>&type=<?php echo "" . $_GET['type'] . ""; ?>&page=<?php echo "" . $_GET['page'] . ""; ?>&Edit=<?php echo "" . $row['id'] . ""; ?>"><img
