...
VALUES ('".$_POST['SupplierID']."','".$paid."','".$DueDate."','".$pay."','','".$notes."','2','".$alldiscount."')";
...
VALUES ('".$_POST['SupplierID']."','".$alldiscount."','".$DueDate."','".$pay."','','خصم نقدى','3','".$alldiscount."')";
...
VALUES ('".$get_LastInvoiceNo."','".$DueDate."','".$inv_Total."','".$_POST['SupplierID']."','".$pay."','','".$CheckNumber."','".$notes."','2','".$paid."','".$alldiscount."')")){
